...
public class Cabang extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId())
        {
            case android.R.id.home:
                startActivity(new Intent(Cabang.this, PegawaiMainActivity.class));
    ...
    public void kosongkanKolom()
    {
        ...
        FancyToast.makeText(Cabang.this, "Kolom dikosongkan", FancyToast.LENGTH_SHORT, FancyToast.INFO, true).show();
    }
    ...
    public void hapus()
    {
        ...
        if(s == null)
        {
            FancyToast.makeText(Cabang.this, "Pilih " +namaKelas +" untuk dihapus", FancyToast.LENGTH_SHORT, FancyToast.INFO, true).show();
        }
        else
        {
            ...
            cabangDAOCall.enqueue(new Callback<CabangDAO>() {
                ...
                public void onResponse(Call<CabangDAO> call, Response<CabangDAO> response) {
                    ...
                    {
                        FancyToast.makeText(Cabang.this, "Gagal menghapus "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                    }
                    else
                    {
                        FancyToast.makeText(Cabang.this, "Gagal menghapus "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                ...
                public void onFailure(Call<CabangDAO> call, Throwable t) {
                    ...
                    {
                        FancyToast.makeText(Cabang.this, "Tidak ada koneksi internet", FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                    }
                    else
                    {
                        FancyToast.makeText(Cabang.this, "Berhasil menghapus "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
                        try {
                            Thread.sleep(1000);
                        }catch (Exception e){
    ...
    public void ubah()
    {
        ...
        if(s == null)
        {
            FancyToast.makeText(Cabang.this, "Pilih " +namaKelas +" untuk diedit", FancyToast.LENGTH_SHORT, FancyToast.INFO, true).show();
        }
        else
        {
            if(namaCabang_tampung.isEmpty() || noTelpCabang_tampung.isEmpty() || alamatCabang_tampung.isEmpty())
            {
                FancyToast.makeText(Cabang.this, "Semua kolom inputan harus terisi", FancyToast.LENGTH_SHORT, FancyToast.WARNING, true).show();
            }
                    ...
                    alamatCabang_tampung.length()>0 && alamatCabang_tampung.length()<10 || alamatCabang_tampung.length()>50)
            {
                ...
                {
                    FancyToast.makeText(Cabang.this, "Nama " +namaKelas +" harus 4-50 huruf", FancyToast.LENGTH_LONG, FancyToast.WARNING, true).show();
                }
                else if(noTelpCabang_tampung.length()<12 || noTelpCabang_tampung.length()>13)
                {
                    FancyToast.makeText(Cabang.this, "Nomor telepon harus 12-13 digit", FancyToast.LENGTH_LONG, FancyToast.WARNING, true).show();
                }
                else if(alamatCabang_tampung.length()<10 || alamatCabang_tampung.length()>50)
                {
                    FancyToast.makeText(Cabang.this, "Alamat " +namaKelas +" harus 10-50 huruf", FancyToast.LENGTH_LONG, FancyToast.WARNING, true).show();
                }
            }
            else
            {
                ...
                cabangDAOCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        FancyToast.makeText(Cabang.this, "Berhasil mengedit "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
                        recreate();
                    }
                    ...
                    public void onFailure(Call<String> call, Throwable t) {
                        ...
                        else
                        {
                            if (t instanceof IOException) {
                                FancyToast.makeText(Cabang.this, "Gagal mengedit "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
    ...
    else
    {
        ...
        cabangDAOCall.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                FancyToast.makeText(Cabang.this, "Berhasil menyimpan "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
                recreate();
            }
            ...
            public void onFailure(Call<String> call, Throwable t) {
                ...
                {
                    if (t instanceof IOException) {
                        FancyToast.makeText(Cabang.this, "Gagal menyimpan "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                        // logging probably not necessary
                    }
                    else {
                        FancyToast.makeText(Cabang.this, "Gagal menyimpan "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
    ...
    public void tampil()
    {
        FancyToast.makeText(Cabang.this, "Sedang menampilkan "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.INFO, true).show();
        Retrofit.Builder builder= new Retrofit
                .Builder()
                .baseUrl(Helper.BASE_URL)
                .addConverterFactory(GsonConverterFactory.create());
        ...
        cabangDAOCall.enqueue(new Callback<List<CabangDAO>>() {
            ...
            public void onResponse(Call<List<CabangDAO>> call, Response<List<CabangDAO>> response) {
                ...
                recyclerAdapterCabang= new RecyclerAdapterCabang(Cabang.this, response.body());
                recyclerView.setAdapter(recyclerAdapterCabang);

                // mengambil data dari response, agar listSparepart2 terisi
                recyclerAdapterCabangSearch.notifyDataSetChanged();
                recyclerAdapterCabangSearch= new RecyclerAdapterCabangSearch(Cabang.this, response.body());
                ...
                FancyToast.makeText(Cabang.this, "Berhasil menampilkan "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
            }
            ...
            public void onFailure(Call<List<CabangDAO>> call, Throwable t) {
                ...
                {
                    if (t instanceof IOException) {
                        FancyToast.makeText(Cabang.this, "Gagal menampilkan "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                        // logging probably not necessary
                    }
                    else {
                        FancyToast.makeText(Cabang.this, "Gagal menampilkan "+namaKelas, FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
