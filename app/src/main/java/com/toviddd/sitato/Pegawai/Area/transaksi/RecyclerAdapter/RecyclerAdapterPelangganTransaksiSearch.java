...
public class RecyclerAdapterPelangganTransaksiSearch extends RecyclerView.Adapter<RecyclerAdapterPelangganTransaksiSearch.MyViewHolder> {

    private List<PelangganDAO> listPelanggan;
    private Context context;
    public String TAG= "Recycler Adapter Pelanggan Transaksi Search";


    public RecyclerAdapterPelangganTransaksiSearch(Context context, List<PelangganDAO> listPelanggan)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.transaksi_menu_recycler_adapter_pelanggan_search, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int position)  {
        ...
        myViewHolder.namaPelanggan.setOnClickListener(new View.OnClickListener() {
            ...
            SharedPreferences pref= context.getSharedPreferences(Helper.PREF_PELANGGAN_TRANSAKSI, Context.MODE_PRIVATE);
